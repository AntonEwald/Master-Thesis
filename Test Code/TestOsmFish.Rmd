...
#Construct pixel matrix with kde values in each element of matrix to use for peak_local_max function for downsampling
...
What to do next time: find out how to normalize vectorfield. Remove data points outside of the border.
